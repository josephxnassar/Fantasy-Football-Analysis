...
export default function DataSources() {
  return (
    <section className="landing-section">
      ...
      <p className="section-subtitle">Player stats, rosters, and opportunity data sourced from the{' '}
        <a href="https://github.com/nflverse" target="_blank" rel="noopener noreferrer">nflverse</a>{' '}project via{' '}
        <a href="https://github.com/nflverse/nfl_data_py" target="_blank" rel="noopener noreferrer">nflreadpy</a>
      </p>
      <div className="landing-sources-grid">
        {DATA_SOURCES.map((src) => (
          <div key={src.name} className="source-card">
            <a href={src.url} target="_blank" rel="noopener noreferrer" className="source-name">{src.name}</a>
