  ...
  return (
    <div className="tab-error-fallback">
      ...
      <div className="tab-error-actions">
        <button className="tab-error-btn secondary" onClick={onGoToDefault}>Go To Statistics</button>
        <button className="tab-error-btn primary" onClick={onRetry}>Retry Tab</button>
      </div>
    </div>
  );
}
