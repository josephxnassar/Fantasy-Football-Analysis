...
const DATA_SOURCES = [
  {
    ...
    description: 'Advanced passing, rushing, and receiving metrics plus snap counts',
  },
  {
    name: 'Next Gen Stats',
    url: 'https://nextgenstats.nfl.com/',
    description: 'Tracking-based metrics — completion probability, separation, rush yards before contact',
  },
];
