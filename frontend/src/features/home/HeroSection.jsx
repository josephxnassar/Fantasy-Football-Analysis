...
import { APP_FUNCTIONAL_DESCRIPTION, HEADER_PROOF_POINTS } from '../../app/brand/content';

export default function HeroSection() {
  return (
    <section className="landing-hero brand-hero brand-hero--home">
      <div className="landing-hero-inner brand-hero-inner">
        ...
        <aside className="landing-hero-visual" aria-hidden="true">
          <div className="hero-visual-card brand-panel">
            <p className="hero-visual-label brand-panel-kicker">Coverage Snapshot</p>
