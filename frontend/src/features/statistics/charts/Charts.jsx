...
export default function Charts({ onPlayerClick, onPlayerSeasonClick }) {
  const {view, setView, position, setPosition, season, setSeason, stat, setStat, topN, setTopN, trendPlayer, setTrendPlayer} = useChartsState();
  const {chartData, loading, error, consistencyEnabled, consistencyData, consistencyLoading, consistencyError, trendEnabled, trendLoading, trendError, barData, statOptions, availableStatOptions, rankedTrendPlayers, trendPlayerOptions, trendSeries, chartSeason} = useChartsData({ view, position, season, stat, topN, trendPlayer });
