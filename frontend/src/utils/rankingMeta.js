...
export const RANKING_GROUPS = {
  ...
  RB: {
    ...
    'Receiving Impact': ['targets', 'rec', 'rec_yds', 'rec_td', 'receiving_yards_after_catch', 'pfr_rec_brk_tkl', 'Yds/Rec', 'receiving_epa', 'pfr_rec_yac_r', 'pfr_rec_drop_pct'],
  },
  WR: {
    ...
    'Route & Separation': ['ng_rec_avg_separation', 'pfr_rec_adot', 'ng_rec_catch_pct', 'ng_rec_avg_yac', 'ng_rec_avg_yac_above_expectation'],
  },
  TE: {
    Opportunity: ['targets', 'target_share', 'air_yards_share', 'wopr', 'sc_offense_pct'],
    'Receiving Production': ['rec', 'rec_yds', 'rec_td', 'receiving_yards_after_catch', 'pfr_rec_brk_tkl'],
