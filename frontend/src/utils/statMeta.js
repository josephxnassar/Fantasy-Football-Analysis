...
export const STAT_META = {
  ...
  ng_rec_avg_yac: { label: 'Avg YAC', description: 'Next Gen tracking YAC per reception. In this app it is seasonized from weekly Next Gen values, so it may differ from PFR\'s YAC/Rec.', format: 'decimal1' },
  ...
  pfr_rec_yac_r: { label: 'YAC/Rec', description: 'PFR charting YAC per reception from seasonal advanced receiving stats. Methodology differs from Next Gen Avg YAC.', format: 'decimal2' },
