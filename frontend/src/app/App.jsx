...
function App() {
  ...
  if (!activeTab)
    return <><HomePage onNavigate={setActiveTab} onPlayerClick={handlePlayerClick} />{playerModal}</>
  ...
  return (
    <div className="App">
      ...
      <main>
        <ErrorBoundary resetKey={activeTab} onReset={() => setActiveTab(DEFAULT_TAB)} fallbackRender={({ resetErrorBoundary }) => (<TabErrorFallback onGoToDefault={() => {setActiveTab(DEFAULT_TAB); resetErrorBoundary()}} onRetry={resetErrorBoundary}/>)}>
