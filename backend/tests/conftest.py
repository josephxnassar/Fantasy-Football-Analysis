...
def _build_statistics_cache() -> Dict[str, Any]:
    qb_2025 = pd.DataFrame({"Comp": [401],
                            "Att": [590],
                            "Pass Yds": [4280],
                            "Pass TD": [32],
                            "INT": [11],
                            "PPR Pts": [352.4],
                            "Non-PPR Pts": [298.2]}, index=pd.Index(["Patrick Mahomes"], name="player_display_name"))
    wr_2025 = pd.DataFrame({"Rec": [109],
                            "Tgt": [151],
                            "Rec Yds": [1462],
                            "Rec TD": [11],
                            "PPR Pts": [311.8],
                            "Non-PPR Pts": [202.8]}, index=pd.Index(["JaMarr Chase"], name="player_display_name"))
    qb_2024 = pd.DataFrame({"Comp": [389],
                            "Att": [575],
                            "Pass Yds": [4065],
                            "Pass TD": [30],
                            "INT": [12],
                            "PPR Pts": [334.1],
                            "Non-PPR Pts": [282.0]}, index=pd.Index(["Patrick Mahomes"], name="player_display_name"))
    ...
    return {constants.STATS["ALL_PLAYERS"]: [{"name": "Patrick Mahomes",
            ...
            constants.STATS["BY_YEAR"]: {2025: {"QB": qb_2025, "WR": wr_2025},
                                         2024: {"QB": qb_2024}},
            constants.STATS["PLAYER_WEEKLY_STATS"]: {"Patrick Mahomes": [{"season": 2025,
                                                                          "week": 1,
                                                                          "Pass Yds": 320,
                                                                          "Pass TD": 3,
                                                                          "INT": 0,
...
def _build_app_caches() -> Dict[str, Any]:
    return {constants.CACHE["STATISTICS"]: _build_statistics_cache(),
